...
// landing page
Route::get('/', function () {
    return view('index', ['judul_halaman' => 'Desa Wisata Galang']);
});
Route::get('/about', function () {
    return view('about', ['judul_halaman' => 'Tentang Kami | Desa Wisata Galang']);
});
Route::get('/gallery', function () {
    return view('gallery', ['judul_halaman' => 'Galeri | Desa Wisata Galang']);
});
Route::get('/blog', function () {
    return view('blog', ['judul_halaman' => 'Blog | Desa Wisata Galang']);
});
Route::get('/blog/slug', function () {
    return view('blog-details', ['judul_halaman' => 'Judul Postingan | Desa Wisata Galang']);
});
Route::get('/contact', function () {
    return view('contact', ['judul_halaman' => 'Kontak Kami | Desa Wisata Galang']);
});
